...
public final class DiseaseDao_Impl implements DiseaseDao {
  ...
  public DiseaseDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfDiseaseKnowledge = new EntityInsertionAdapter<DiseaseKnowledge>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `diseases_knowledge` (`diseaseId`,`name`,`affectedCrops`,`symptoms`,`naturalTreatment`,`chemicalTreatment`,`prevention`,`imageResId`) VALUES (?,?,?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, DiseaseKnowledge value) {
        ...
        if (value.getNaturalTreatment() == null) {
          ...
          stmt.bindString(5, value.getNaturalTreatment());
        }
        if (value.getChemicalTreatment() == null) {
          stmt.bindNull(6);
        } else {
          stmt.bindString(6, value.getChemicalTreatment());
        }
        ...
        stmt.bindLong(8, value.getImageResId());
      }
    };
    this.__insertionAdapterOfDiseaseReport = new EntityInsertionAdapter<DiseaseReport>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR IGNORE INTO `disease_reports` (`id`,`diseaseName`,`cropType`,`latitude`,`longitude`,`timestamp`,`isSynced`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
  ...
  @Override
  public Object insertReport(final DiseaseReport report, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
  ...
  @Override
  public Object markReportAsSynced(final long reportId, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
      ...
      public List<DiseaseKnowledge> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new DiseaseKnowledge(_tmpDiseaseId,_tmpName,_tmpAffectedCrops,_tmpSymptoms,_tmpNaturalTreatment,_tmpChemicalTreatment,_tmpPrevention,_tmpImageResId);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Object getKnowledgeByName(final String name,
      final Continuation<? super DiseaseKnowledge> arg1) {
      ...
      public DiseaseKnowledge call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            final int _tmpImageResId;
            _tmpImageResId = _cursor.getInt(_cursorIndexOfImageResId);
            _result = new DiseaseKnowledge(_tmpDiseaseId,_tmpName,_tmpAffectedCrops,_tmpSymptoms,_tmpNaturalTreatment,_tmpChemicalTreatment,_tmpPrevention,_tmpImageResId);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<DiseaseReport> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _tmpIsSynced = _tmp != 0;
            _item = new DiseaseReport(_tmpId,_tmpDiseaseName,_tmpCropType,_tmpLatitude,_tmpLongitude,_tmpTimestamp,_tmpIsSynced);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getUnsyncedReports(final Continuation<? super List<DiseaseReport>> arg0) {
