...
class ResultActivity : AppCompatActivity() {
    ...
    private fun setupObservers() {
        viewModel.diagnosticResult.observe(this) { result ->
            ...
            if (result.diseaseId.contains("healthy", true)) {
        ...
        viewModel.diseaseKnowledge.observe(this) { knowledge ->
            if (knowledge != null) {
                binding.txtCause.text = "Cause : ${knowledge.cause}"
                ...
                binding.txtCause.text = "Cause : Inconnue"
    ...
    private fun setupClickListeners() {
        ...
        binding.btnSaveFeedback.setOnClickListener {
            ...
            // Ici, on pourrait appeler une fonction du ViewModel pour sauvegarder l'avis
            Toast.makeText(this, "Merci pour votre avis !", Toast.LENGTH_SHORT).show()
            binding.cardEvaluation.visibility = View.GONE
        }
    }
    ...
    private fun shareResult() {
        ...
        val shareIntent = Intent().apply {
            ...
            putExtra(Intent.EXTRA_TEXT, "AgriGuard a détecté : $diseaseName sur ma culture. Cause possible : ${binding.txtCause.text}")
        }
