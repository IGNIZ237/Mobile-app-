...
public final class ActivityCameraBinding implements ViewBinding {
  ...
  private ActivityCameraBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull View guideFrame, @NonNull TextView txtHint, @NonNull PreviewView viewFinder) {
  ...
  public static ActivityCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCameraBinding((ConstraintLayout) rootView, btnCapture, btnGallery,
          guideFrame, txtHint, viewFinder);
    }
